...
Gauge[[4]]={Bp,  U[1], U1L,         g1p, False, 1, 1};
...
FermionFields[[6]]  = { v, 2, conj[vR],    0, 1,  1,   -5,  1,  1};
FermionFields[[7]]  = {CL, 1,       cl,    0, 1,  1,    6, -1,  1};
FermionFields[[8]]  = {CR, 1, conj[cr],    0, 1,  1,   -1, -1,  1};
FermionFields[[9]]  = {XL, 1,       xl,    0, 1,  1,    3,  1, -1};
FermionFields[[10]] = {XR, 1, conj[xr],    0, 1,  1,    2,  1, -1};

ScalarFields[[1]] = { H, 1, {H0, Hm}, -1/2, 2,  1,   0, 1, 1};
ScalarFields[[2]] = {bi, 1,      BiD,    0, 1,  1,  -5, 1, 1};
...
LagHC = - (+ Yd H.d.q + Ye H.e.l - Yu conj[H].u.q  + Yc bi.CL.CR + Yx bi.XL.XR );
